...
class PurchaseOrderConfirmAccountingButton extends StatelessWidget {
  const PurchaseOrderConfirmAccountingButton._({
  ...
  static Widget prepare({
    ...
    return BlocProvider(
      ...
      child:
          PurchaseOrderConfirmAccountingButton._(purchaseOrder: purchaseOrder),
    );
  }
  ...
  Widget build(BuildContext context) {
    const action = DataAction.accountingConfirm;
          ...
          child: BlocBuilder<PurchaseOrderBloc, PurchaseOrderState>(
            ...
            builder: (context, state) {
              ...
              return CardConfirmation(
                ...
                onConfirm: () {
                  bloc.add(PurchaseOrderEvent.accountingConfirm(purchaseOrder));
                },
              );
            },
          ),
