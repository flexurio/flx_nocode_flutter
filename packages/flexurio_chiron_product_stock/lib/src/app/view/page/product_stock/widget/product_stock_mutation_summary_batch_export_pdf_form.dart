...
import 'package:flexurio_chiron_product_stock/src/app/bloc/product_stock_mutation_summary_batch_query/product_stock_mutation_summary_batch_query_bloc.dart';
import 'package:flexurio_chiron_product_stock/src/app/view/page/product_stock/util/pdf_product_stock_card_mutation_summary_batch.dart';
...
class ProductStockMutationSummaryBatchExportPdfForm extends StatefulWidget {
  const ProductStockMutationSummaryBatchExportPdfForm._();

  static Widget prepare() {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => ProductStockMutationSummaryBatchQueryBloc(),
        ),
        BlocProvider(
      ...
      child: const ProductStockMutationSummaryBatchExportPdfForm._(),
    );
  }

  @override
  State<ProductStockMutationSummaryBatchExportPdfForm> createState() =>
      _ProductStockMutationSummaryBatchExportPdfFormState();
}

class _ProductStockMutationSummaryBatchExportPdfFormState
    extends State<ProductStockMutationSummaryBatchExportPdfForm> {
  ...
  void _submit(BuildContext context) {
    if (_formKey.currentState!.validate()) {
      context.read<ProductStockMutationSummaryBatchQueryBloc>().add(
            ProductStockMutationSummaryBatchQueryEvent.fetch(
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<ProductStockMutationSummaryBatchQueryBloc,
        ...
        state.maybeWhen(
          ...
          loaded: (pageOptions) async {
            final pdf = pw.Document()
              ..addPage(
                await pdfProductStockCardMutationSummaryBatch(
            ...
            await Printing.sharePdf(
              ...
              filename: 'Report_Mutasi_Per_Batch.pdf',
            );
      ...
      child: CardForm(
        ...
        actions: [
          ...
          const Gap(12),
          BlocBuilder<ProductStockMutationSummaryBatchQueryBloc,
              ProductStockMutationSummaryBatchQueryState>(
