...
import 'package:flexurio_chiron_material_stock/src/app/view/page/material_receive_create/widget/temporary_detail_delete_button.dart';
import 'package:easy_localization/easy_localization.dart';
import 'package:flexurio_erp_core/flexurio_erp_core.dart';
import 'package:flutter/widgets.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class MaterialReceiveDetailTemporaryTable extends StatelessWidget {
  const MaterialReceiveDetailTemporaryTable({super.key});
        ...
        return YuhuTable<MaterialReceiveDetail>(
          ...
          columns: [
            ...
            TableColumn(
              title: 'actions'.tr(),
              builder: (materialReceiveDetail, _) {
                return MaterialReceiveTemporaryDetailDeleteButton(
