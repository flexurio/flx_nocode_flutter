...
import 'package:flexurio_chiron_finance/src/app/view/page/accounts_receivable_detail/util/pdf_invoice.dart';
                ...
                state.maybeWhen(
                  ...
                  loaded: (accountsReceivableDetail) async {
                    ...
                    await Printing.sharePdf(
                      ...
                      filename:
                          'LPU - LAPORAN SALDO PIUTANG DETAIL by TGL FAKTUR KHUSUS.pdf',
                    );
                  },
                );
              },
