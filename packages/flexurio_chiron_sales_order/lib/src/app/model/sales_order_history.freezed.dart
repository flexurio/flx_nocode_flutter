...
mixin _$SalesOrderHistory {
  ...
  SalesOrderHistoryStatus get status => throw _privateConstructorUsedError;
  ...
  @JsonKey(name: 'product_request_id')
...
abstract class $SalesOrderHistoryCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(
          name: 'status',
          fromJson: SalesOrderHistoryStatus.salesOrderStatusFromString)
      SalesOrderHistoryStatus status,
      double subtotal,
      ...
      @JsonKey(name: 'is_toll_in') bool isTollIn,
      @JsonKey(name: 'delivery_order_open_remark')
...
class _$SalesOrderHistoryCopyWithImpl<$Res, $Val extends SalesOrderHistory>
  ...
  $Res call({
    ...
    Object? productRequestId = freezed,
    ...
    return _then(_value.copyWith(
      ...
      deliveryOrderOpenRemark: freezed == deliveryOrderOpenRemark
          ...
          : deliveryOrderOpenRemark // ignore: cast_nullable_to_non_nullable
              as String?,
      productRequestId: freezed == productRequestId
...
/// @nodoc
@JsonSerializable()
class _$SalesOrderHistoryImpl extends _SalesOrderHistory {
  const _$SalesOrderHistoryImpl(
      ...
      @JsonKey(name: 'is_toll_in') required this.isTollIn,
      @JsonKey(name: 'delivery_order_open_remark') this.deliveryOrderOpenRemark,
      @JsonKey(name: 'product_request_id') this.productRequestId,
      @JsonKey(name: 'sales_order_id', fromJson: SalesOrder.fromJson)
      this.salesOrder})
      : super._();
  ...
  @JsonKey(
      name: 'status',
      fromJson: SalesOrderHistoryStatus.salesOrderStatusFromString)
  final SalesOrderHistoryStatus status;
  @override
  ...
  @override
  String toString() {
    return 'SalesOrderHistory(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, productIssueId: $productIssueId, deliveryOrderId: $deliveryOrderId, invoiceId: $invoiceId, status: $status, subtotal: $subtotal, discountPercent: $discountPercent, discountValue: $discountValue, subtotalAfterDiscount: $subtotalAfterDiscount, ppnPercent: $ppnPercent, ppnValue: $ppnValue, total: $total, exchangedValue: $exchangedValue, pph22Percent: $pph22Percent, pph22Value: $pph22Value, description: $description, bankFee: $bankFee, additionalDiscountType: $additionalDiscountType, additionalDiscountPercent: $additionalDiscountPercent, additionalDiscountValue: $additionalDiscountValue, specialDiscountPercent: $specialDiscountPercent, isConfirmAt: $isConfirmAt, bonus: $bonus, revisionNo: $revisionNo, isTollIn: $isTollIn, deliveryOrderOpenRemark: $deliveryOrderOpenRemark, productRequestId: $productRequestId, salesOrder: $salesOrder)';
  }
...
abstract class _SalesOrderHistory extends SalesOrderHistory {
  const factory _SalesOrderHistory(
      ...
      @JsonKey(
          name: 'status',
          fromJson: SalesOrderHistoryStatus.salesOrderStatusFromString)
      required final SalesOrderHistoryStatus status,
      ...
      @JsonKey(name: 'is_toll_in') required final bool isTollIn,
      @JsonKey(name: 'delivery_order_open_remark')
      final String? deliveryOrderOpenRemark,
      @JsonKey(name: 'product_request_id') final String? productRequestId,
      @JsonKey(name: 'sales_order_id', fromJson: SalesOrder.fromJson)
      final SalesOrder? salesOrder}) = _$SalesOrderHistoryImpl;
  const _SalesOrderHistory._() : super._();
  ...
  @JsonKey(
      name: 'status',
      fromJson: SalesOrderHistoryStatus.salesOrderStatusFromString)
  SalesOrderHistoryStatus get status;
  @override
  double get subtotal;
  @override
  @JsonKey(name: 'discount_percent')
