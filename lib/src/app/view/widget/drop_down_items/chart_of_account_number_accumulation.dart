...
class FDropDownSearchChartOfAccountNumberAccumulation extends StatelessWidget
    implements DropDownObject<ChartOfAccountNumber> {
  const FDropDownSearchChartOfAccountNumberAccumulation({
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ChartOfAccountNumberAccumulationQueryBloc,
