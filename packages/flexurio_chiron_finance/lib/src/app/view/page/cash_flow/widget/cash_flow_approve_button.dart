...
class CashFlowApproveButton extends StatelessWidget {
  const CashFlowApproveButton({
  ...
  static Widget prepare({
    ...
    return BlocProvider(
      ...
      child: CashFlowApproveButton(cashFlow: cashFlow, company: company),
    );
  }
  ...
  Widget build(BuildContext context) {
    return IconButtonSmall(
      permission: Permission.cashFlowApprove,
      ...
      onPressed: () async {
        ...
        final success = await _showApproveDialog(context, cashFlowBloc);
        if (success ?? false) {
          ...
          child: BlocBuilder<CashFlowBloc, CashFlowState>(
            ...
            builder: (context, state) {
              ...
              return CardConfirmation(
                ...
                onConfirm: () {
                  cashFlowBloc
                      .add(CashFlowEvent.approve(cashFlow.noTransaction));
                },
              );
            },
          ),
