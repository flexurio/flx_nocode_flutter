...
Future<Page> pdfSalesOrderDonationSummaryHna({
  required List<SalesOrderDonationSummary> data,
  DateTime? startDate,
  DateTime? endDate,
}) async {
  final printedBy = UserRepositoryApp.instance.userApp?.name ?? '';

  final groupByTypeProduct = groupBy<SalesOrderDonationSummary>(
    data,
          ...
          return Column(
            ...
            children: [
              ...
              ...List.generate(data.value.length, (index) {
                return tableBody<SalesOrderDonationSummary>(
