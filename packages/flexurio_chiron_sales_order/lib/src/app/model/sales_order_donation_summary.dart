...
part 'sales_order_donation_summary.freezed.dart';
part 'sales_order_donation_summary.g.dart';

@freezed
class SalesOrderDonationSummary with _$SalesOrderDonationSummary {
  const factory SalesOrderDonationSummary({
  ...
  }) = _SalesOrderDonationSummary;
  const SalesOrderDonationSummary._();

  factory SalesOrderDonationSummary.empty() => SalesOrderDonationSummary(
    productType: '', 
  ...
  factory SalesOrderDonationSummary.fromJson(Map<String, dynamic> json) => _$SalesOrderDonationSummaryFromJson(json);
}
