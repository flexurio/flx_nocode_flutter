...
class ProductMutationSummaryExportPdfForm extends StatefulWidget {
  const ProductMutationSummaryExportPdfForm._();
  ...
  static Widget prepare() {
    return MultiBlocProvider(
      ...
      child: const ProductMutationSummaryExportPdfForm._(),
    );
  }

  @override
  State<ProductMutationSummaryExportPdfForm> createState() =>
      _ProductMutationSummaryExportPdfFormState();
}

class _ProductMutationSummaryExportPdfFormState
    extends State<ProductMutationSummaryExportPdfForm> {
