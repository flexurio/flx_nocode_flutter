...
SalesOrderMalkSummary _$SalesOrderMalkSummaryFromJson(
    Map<String, dynamic> json) {
  return _SalesOrderMalkSummary.fromJson(json);
}

/// @nodoc
mixin _$SalesOrderMalkSummary {
  ...
  /// Serializes this SalesOrderMalkSummary to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of SalesOrderMalkSummary
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $SalesOrderMalkSummaryCopyWith<SalesOrderMalkSummary> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SalesOrderMalkSummaryCopyWith<$Res> {
  factory $SalesOrderMalkSummaryCopyWith(SalesOrderMalkSummary value,
          $Res Function(SalesOrderMalkSummary) then) =
      _$SalesOrderMalkSummaryCopyWithImpl<$Res, SalesOrderMalkSummary>;
  @useResult
  $Res call(
...
/// @nodoc
class _$SalesOrderMalkSummaryCopyWithImpl<$Res,
        $Val extends SalesOrderMalkSummary>
    implements $SalesOrderMalkSummaryCopyWith<$Res> {
  _$SalesOrderMalkSummaryCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$SalesOrderMalkSummaryImplCopyWith<$Res>
    implements $SalesOrderMalkSummaryCopyWith<$Res> {
  factory _$$SalesOrderMalkSummaryImplCopyWith(
          _$SalesOrderMalkSummaryImpl value,
          $Res Function(_$SalesOrderMalkSummaryImpl) then) =
      __$$SalesOrderMalkSummaryImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'sales_order_id') String salesOrderId,
...
/// @nodoc
class __$$SalesOrderMalkSummaryImplCopyWithImpl<$Res>
    extends _$SalesOrderMalkSummaryCopyWithImpl<$Res,
        _$SalesOrderMalkSummaryImpl>
    implements _$$SalesOrderMalkSummaryImplCopyWith<$Res> {
  __$$SalesOrderMalkSummaryImplCopyWithImpl(_$SalesOrderMalkSummaryImpl _value,
      $Res Function(_$SalesOrderMalkSummaryImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$SalesOrderMalkSummaryImpl(
      salesOrderId: null == salesOrderId
          ? _value.salesOrderId
          : salesOrderId // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$SalesOrderMalkSummaryImpl extends _SalesOrderMalkSummary {
  const _$SalesOrderMalkSummaryImpl(
  ...
  factory _$SalesOrderMalkSummaryImpl.fromJson(Map<String, dynamic> json) =>
      _$$SalesOrderMalkSummaryImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$SalesOrderMalkSummaryImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SalesOrderMalkSummaryImplCopyWith<_$SalesOrderMalkSummaryImpl>
      get copyWith => __$$SalesOrderMalkSummaryImplCopyWithImpl<
          _$SalesOrderMalkSummaryImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$SalesOrderMalkSummaryImplToJson(
      this,
    );
  }
}

abstract class _SalesOrderMalkSummary extends SalesOrderMalkSummary {
  const factory _SalesOrderMalkSummary(
      ...
      @JsonKey(name: 'delivery_order_date', fromJson: isoDateToDateTime)
      required final DateTime deliveryOrderDate}) = _$SalesOrderMalkSummaryImpl;
  const _SalesOrderMalkSummary._() : super._();

  factory _SalesOrderMalkSummary.fromJson(Map<String, dynamic> json) =
      _$SalesOrderMalkSummaryImpl.fromJson;
