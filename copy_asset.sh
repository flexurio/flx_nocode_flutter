create_asset() {
    ...
    sed -i "s/import 'package:appointment\/constant\/menu\/menu.dart' as appointment;/import 'package:$PACKAGE\/constant\/menu.dart' as $PACKAGE;/" packages/$PACKAGE/lib/main_{chiron_demo,anton_paar_development,mf_{development,production},tl_{development,production}}.dart

    # Replace all instances of 'appointment.menu' with '$PACKAGE.menu' in the main dart files
    ...
    sed -i "s/appointment\.menu/$PACKAGE\.menu/g" packages/$PACKAGE/lib/main_{chiron_demo,anton_paar_development,mf_{development,production},tl_{development,production}}.dart
