...
Future<Page> pdfAccountsPayablePaymentGlobal({
  required List<AccountsPayablePaymentGlobal> data,
}) async {
  ...
  return MultiPage(
    ...
    build: (Context context) {
      return [
        simpleTablePdf<AccountsPayablePaymentGlobal>(
          data: data,
          columns: [
            PColumn(
              title: 'code'.tr(),
              contentBuilder: (data, index) => data.supplierId,
            ),
            PColumn(
