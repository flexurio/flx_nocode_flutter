...
class SummaryFieldForceYearReportData extends StatefulWidget {
  const SummaryFieldForceYearReportData({
  ...
  final List<SummaryFieldForceYearGrade1> summaryFieldForces;
  final int year;
  ...
  @override
  State<SummaryFieldForceYearReportData> createState() =>
      _SummaryFieldForceYearReportDataState();
}

class _SummaryFieldForceYearReportDataState
    extends State<SummaryFieldForceYearReportData> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget buildSummaryFFsValue({
      required SummaryFieldForceYear summaryFieldForce,
      required int month,
