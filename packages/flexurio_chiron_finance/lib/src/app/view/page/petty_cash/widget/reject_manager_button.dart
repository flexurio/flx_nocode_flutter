...
class PettyCashRejectManagerButton extends StatelessWidget {
  const PettyCashRejectManagerButton._({
  ...
  static Widget prepare(PettyCash pettyCash) {
    return BlocProvider(
      ...
      child: PettyCashRejectManagerButton._(pettyCash: pettyCash),
    );
  }
