...
Future<Page> pdfSalesOrderMalkSummaryHna({
  required List<SalesOrderMalkSummary> data,
  DateTime? startDate,
  DateTime? endDate,
}) async {
  final printedBy = UserRepositoryApp.instance.userApp?.name ?? '';

  final groupByTypeProduct = groupBy<SalesOrderMalkSummary>(
    data,
          ...
          return Column(
            ...
            children: [
              ...
              ...List.generate(data.value.length, (index) {
                return tableBody<SalesOrderMalkSummary>(
                  ...
                  columns: [
                    ...
                    PColumnBody(
                      flex: 2,
                      contentBuilder: (data, index) =>
                          data.productDiscountPercent.format(),
                    ),
                    PColumnBody(
                      flex: 2,
                      contentBuilder: (data, index) =>
                          data.additionalDiscountPercent.format(),
                    ),
                    PColumnBody(
                      contentBuilder: (data, index) =>
              ...
              tableFooter(
                columns: [
                  ...
                  PColumnFooter(borderTransparent: true),
                  PColumnFooter(borderTransparent: true),
                  PColumnFooter(flex: 2, borderTransparent: true),
                  PColumnFooter(flex: 2, borderTransparent: true),
                  PColumnFooter(borderTransparent: true),
                  PColumnFooter(borderTransparent: true),
                  PColumnFooter(borderTransparent: true),
              ...
              tableFooter(
                columns: [
                  ...
                  PColumnFooter(
                    flex: 2,
                    footer: (totalQty / totalQtyDelivery * 100).format(),
                  ),
                  PColumnFooter(),
                  PColumnFooter(
                    footer: 'REALISASI',
                  ...
                  PColumnFooter(),
                  PColumnFooter(
                    footer: (totalValueSalesOrder / totalValueRealization * 100)
                        .format(),
                  ),
                ],
              ),
              ...
              tableFooter(
                columns: [
                  ...
                  PColumnFooter(
                    flex: 2,
                    footer: (totalQtyAll / totalQtyDeliveryAll * 100).format(),
                  ),
                  PColumnFooter(
                    flex: 2,
                    footer: 'REALISASI SELURUH',
                  ...
                  PColumnFooter(),
                  PColumnFooter(
                    footer: (totalValueSalesOrderAll /
                            totalValueRealizationAll *
                            100)
                        .format(),
                  ),
                ],
