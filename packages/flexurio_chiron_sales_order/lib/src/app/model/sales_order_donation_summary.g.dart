...
_$SalesOrderDonationSummaryImpl _$$SalesOrderDonationSummaryImplFromJson(
...
Map<String, dynamic> _$$SalesOrderDonationSummaryImplToJson(
        _$SalesOrderDonationSummaryImpl instance) =>
    <String, dynamic>{
