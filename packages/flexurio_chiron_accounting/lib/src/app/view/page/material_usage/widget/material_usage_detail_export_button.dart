...
import 'package:flexurio_chiron_accounting/src/app/view/page/material_usage/util/pdf_material_usage_detail.dart';
...
class MaterialUsageDetailExportPdfButton extends StatefulWidget {
  const MaterialUsageDetailExportPdfButton({super.key});

  static Widget prepare() {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => MaterialUsageDetailQueryBloc(),
        ),
        BlocProvider(
      ...
      child: const MaterialUsageDetailExportPdfButton(),
    );
  }

  @override
  State<MaterialUsageDetailExportPdfButton> createState() =>
      _MaterialUsageDetailExportPdfButtonState();
}

class _MaterialUsageDetailExportPdfButtonState
    extends State<MaterialUsageDetailExportPdfButton> {
  ...
  Widget build(BuildContext context) {
    final queryBloc = context.read<MaterialUsageDetailQueryBloc>();
    ...
    return LightButtonSmall(
      ...
      title: 'Recap Usage Material Detail',
      permission: PermissionAccounting.recapUsageMaterialDetailExportPdf,
      onPressed: () async {
        await _showFilter(
          context,
          queryBloc,
  ...
  Future<void> _showFilter(
    ...
    MaterialUsageDetailQueryBloc queryBloc,
      ...
      builder: (BuildContext context) {
        return CardForm(
          ...
          actions: [
            ...
            BlocListener<MaterialUsageDetailQueryBloc,
              ...
              listener: (context, state) {
                state.maybeWhen(
                  ...
                  loaded: (materialUsageDetail) async {
                    final pdf = pw.Document()
                      ..addPage(
                        await pdfMaterialUsageDetail(
                          data: materialUsageDetail.data,
                        ),
                      );
                    await Printing.sharePdf(
                      bytes: await pdf.save(),
                      filename: 'Recap_Usage_Material_Detail.pdf',
                    );
                  },
                );
              },
              child: BlocBuilder<MaterialUsageDetailQueryBloc,
                  MaterialUsageDetailQueryState>(
                bloc: queryBloc,
                  ...
                  return Button.small(
                    ...
                    onPressed: () {
                      if (_transactionType != null &&
                          ...
                          _endDate != null) {
                        queryBloc.add(
                          MaterialUsageDetailQueryEvent.fetch(
                            transactionType: _transactionType,
                            materialGroup: _materialGroup,
