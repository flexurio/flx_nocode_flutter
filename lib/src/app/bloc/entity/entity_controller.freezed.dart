...
part of 'entity_controller.dart';
...
/// @nodoc
mixin _$EntityState implements DiagnosticableTreeMixin {
  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    properties..add(DiagnosticsProperty('type', 'EntityState'));
  }
...
class Initial with DiagnosticableTreeMixin implements EntityState {
  const Initial();
...
class Loading with DiagnosticableTreeMixin implements EntityState {
  const Loading();
...
class Success with DiagnosticableTreeMixin implements EntityState {
...
class Error with DiagnosticableTreeMixin implements EntityState {
