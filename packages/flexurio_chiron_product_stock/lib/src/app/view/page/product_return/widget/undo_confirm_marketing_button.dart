...
class ProductReturnUndoConfirmMarketingButton extends StatelessWidget {
  const ProductReturnUndoConfirmMarketingButton({
  ...
  static Widget prepare({
    ...
    return BlocProvider(
      ...
      child: ProductReturnUndoConfirmMarketingButton(
  ...
  Widget build(BuildContext context) {
    const action = DataAction.undoConfirmMarketing;
    return LightButton(
      permission: PermissionProductStock.productReturnConfirmMarketing,
      action: action,
      onPressed: () async {
          ...
          child: BlocBuilder<ProductReturnBloc, ProductReturnState>(
            ...
            builder: (context, state) {
              ...
              return CardConfirmation(
                ...
                onConfirm: () {
                  bloc.add(
                    ProductReturnEvent.undoConfirmMarketing(
                      productReturn: productReturn,
                    ),
                  );
                },
