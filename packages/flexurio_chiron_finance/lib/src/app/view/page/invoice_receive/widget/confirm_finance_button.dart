...
class InvoiceReceiveConfirmFinanceButton extends StatelessWidget {
  const InvoiceReceiveConfirmFinanceButton({
  ...
  static Widget prepare({
    ...
    return BlocProvider(
      ...
      child: InvoiceReceiveConfirmFinanceButton(
  ...
  Widget build(BuildContext context) {
    return LightButton(
      permission: Permission.invoiceReceiveConfirmFinance,
      action: DataAction.confirmFinance,
      onPressed: () async {
  ...
  Future<bool?> _showDeleteDialog({
    ...
    const action = DataAction.confirmFinance;
          ...
          child: BlocBuilder<InvoiceReceiveBloc, InvoiceReceiveState>(
            ...
            builder: (context, state) {
              ...
              return CardConfirmation(
                ...
                onConfirm: () {
                  bloc.add(
                    InvoiceReceiveEvent.confirmFinance(
                      invoiceReceive: invoiceReceive,
                    ),
                  );
                },
