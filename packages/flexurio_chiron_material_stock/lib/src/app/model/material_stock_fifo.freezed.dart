...
MaterialStockFifo _$MaterialStockFifoFromJson(Map<String, dynamic> json) {
  return _MaterialStockFifo.fromJson(json);
}

/// @nodoc
mixin _$MaterialStockFifo {
  ...
  @JsonKey(ignore: true)
  $MaterialStockFifoCopyWith<MaterialStockFifo> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $MaterialStockFifoCopyWith<$Res> {
  factory $MaterialStockFifoCopyWith(
          MaterialStockFifo value, $Res Function(MaterialStockFifo) then) =
      _$MaterialStockFifoCopyWithImpl<$Res, MaterialStockFifo>;
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class _$MaterialStockFifoCopyWithImpl<$Res, $Val extends MaterialStockFifo>
    implements $MaterialStockFifoCopyWith<$Res> {
  _$MaterialStockFifoCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$MaterialStockFifoImplCopyWith<$Res>
    implements $MaterialStockFifoCopyWith<$Res> {
  factory _$$MaterialStockFifoImplCopyWith(_$MaterialStockFifoImpl value,
          $Res Function(_$MaterialStockFifoImpl) then) =
      __$$MaterialStockFifoImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$MaterialStockFifoImplCopyWithImpl<$Res>
    extends _$MaterialStockFifoCopyWithImpl<$Res, _$MaterialStockFifoImpl>
    implements _$$MaterialStockFifoImplCopyWith<$Res> {
  __$$MaterialStockFifoImplCopyWithImpl(_$MaterialStockFifoImpl _value,
      $Res Function(_$MaterialStockFifoImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$MaterialStockFifoImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$MaterialStockFifoImpl extends _MaterialStockFifo {
  const _$MaterialStockFifoImpl(
      {required this.id,
      @JsonKey(name: 'material', fromJson: Material.fromJson)
  ...
  factory _$MaterialStockFifoImpl.fromJson(Map<String, dynamic> json) =>
      _$$MaterialStockFifoImplFromJson(json);
  ...
  @override
  String toString() {
    return 'MaterialStockFifo(id: $id, material: $material, materialGroup: $materialGroup, createdAt: $createdAt, updatedAt: $updatedAt, createdById: $createdById, updatedById: $updatedById, period: $period, na: $na, quantityIn: $quantityIn, quantityOut: $quantityOut, beginningBalance: $beginningBalance, endingBalance: $endingBalance, expiredDate: $expiredDate, releasedDate: $releasedDate)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$MaterialStockFifoImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$MaterialStockFifoImplCopyWith<_$MaterialStockFifoImpl> get copyWith =>
      __$$MaterialStockFifoImplCopyWithImpl<_$MaterialStockFifoImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$MaterialStockFifoImplToJson(
      this,
    );
  }
}

abstract class _MaterialStockFifo extends MaterialStockFifo {
  const factory _MaterialStockFifo(
      ...
      @JsonKey(name: 'released_date', fromJson: isoDateToDateTime)
      required final DateTime releasedDate}) = _$MaterialStockFifoImpl;
  const _MaterialStockFifo._() : super._();

  factory _MaterialStockFifo.fromJson(Map<String, dynamic> json) =
      _$MaterialStockFifoImpl.fromJson;
