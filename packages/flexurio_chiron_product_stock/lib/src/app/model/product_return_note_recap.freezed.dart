...
ProductReturnNoteRecap _$ProductReturnNoteRecapFromJson(
    Map<String, dynamic> json) {
  return _ProductReturnNoteRecap.fromJson(json);
}

/// @nodoc
mixin _$ProductReturnNoteRecap {
  @JsonKey(name: 'product_return_id')
  ...
  @JsonKey(ignore: true)
  $ProductReturnNoteRecapCopyWith<ProductReturnNoteRecap> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ProductReturnNoteRecapCopyWith<$Res> {
  factory $ProductReturnNoteRecapCopyWith(ProductReturnNoteRecap value,
          $Res Function(ProductReturnNoteRecap) then) =
      _$ProductReturnNoteRecapCopyWithImpl<$Res, ProductReturnNoteRecap>;
  @useResult
  $Res call(
      {@JsonKey(name: 'product_return_id') String productReturnId,
...
/// @nodoc
class _$ProductReturnNoteRecapCopyWithImpl<$Res,
        $Val extends ProductReturnNoteRecap>
    implements $ProductReturnNoteRecapCopyWith<$Res> {
  _$ProductReturnNoteRecapCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ProductReturnNoteRecapImplCopyWith<$Res>
    implements $ProductReturnNoteRecapCopyWith<$Res> {
  factory _$$ProductReturnNoteRecapImplCopyWith(
          _$ProductReturnNoteRecapImpl value,
          $Res Function(_$ProductReturnNoteRecapImpl) then) =
      __$$ProductReturnNoteRecapImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'product_return_id') String productReturnId,
...
/// @nodoc
class __$$ProductReturnNoteRecapImplCopyWithImpl<$Res>
    extends _$ProductReturnNoteRecapCopyWithImpl<$Res,
        _$ProductReturnNoteRecapImpl>
    implements _$$ProductReturnNoteRecapImplCopyWith<$Res> {
  __$$ProductReturnNoteRecapImplCopyWithImpl(
      _$ProductReturnNoteRecapImpl _value,
      $Res Function(_$ProductReturnNoteRecapImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ProductReturnNoteRecapImpl(
      productReturnId: null == productReturnId
          ? _value.productReturnId
          : productReturnId // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$ProductReturnNoteRecapImpl extends _ProductReturnNoteRecap {
  _$ProductReturnNoteRecapImpl(
      {@JsonKey(name: 'product_return_id') required this.productReturnId,
  ...
  factory _$ProductReturnNoteRecapImpl.fromJson(Map<String, dynamic> json) =>
      _$$ProductReturnNoteRecapImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ProductReturnNoteRecap(productReturnId: $productReturnId, description: $description, deliveryOrderId: $deliveryOrderId, customer: $customer, referenceNo: $referenceNo, warehouse: $warehouse, product: $product, quantity: $quantity, unitId: $unitId, taxInvoiceNo: $taxInvoiceNo, productPrice: $productPrice, batchNo: $batchNo, discountPercent: $discountPercent, createdAt: $createdAt, deliveryOrderDate: $deliveryOrderDate, expirationDate: $expirationDate)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ProductReturnNoteRecapImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ProductReturnNoteRecapImplCopyWith<_$ProductReturnNoteRecapImpl>
      get copyWith => __$$ProductReturnNoteRecapImplCopyWithImpl<
          _$ProductReturnNoteRecapImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ProductReturnNoteRecapImplToJson(
      this,
    );
  }
}

abstract class _ProductReturnNoteRecap extends ProductReturnNoteRecap {
  factory _ProductReturnNoteRecap(
      {@JsonKey(name: 'product_return_id')
      ...
      @JsonKey(name: 'expiration_date', fromJson: isoDateToDateTime)
      required final DateTime expirationDate}) = _$ProductReturnNoteRecapImpl;
  _ProductReturnNoteRecap._() : super._();

  factory _ProductReturnNoteRecap.fromJson(Map<String, dynamic> json) =
      _$ProductReturnNoteRecapImpl.fromJson;
