...
class DebtBalanceGlobalDueDateExportPdfButton extends StatefulWidget {
  const DebtBalanceGlobalDueDateExportPdfButton({super.key});
  ...
  static Widget prepare() {
    return MultiBlocProvider(
      ...
      child: const DebtBalanceGlobalDueDateExportPdfButton(),
    );
  }

  @override
  State<DebtBalanceGlobalDueDateExportPdfButton> createState() =>
      _DebtBalanceGlobalDueDateExportPdfButtonState();
}

class _DebtBalanceGlobalDueDateExportPdfButtonState
    extends State<DebtBalanceGlobalDueDateExportPdfButton> {
  DateTime? _dueDate;
  ...
  Widget build(BuildContext context) {
    ...
    return LightButtonSmall(
      ...
      title: 'Global Due Date',
      permission: PermissionAccounting.debtBalanceGlobalDueDateExportPdf,
      onPressed: () async {
        await _showFilter(
          context,
          queryBloc,
                ...
                state.maybeWhen(
                  ...
                  loaded: (debtBalanceGlobalInvoiceDate) async {
                    ...
                    await Printing.sharePdf(
                      ...
                      filename: 'Debt_Balance_Global_Due_Date.pdf',
                    );
                  },
                );
              },
