...
class PettyCashApproveAccountingButton extends StatelessWidget {
  const PettyCashApproveAccountingButton._({
  ...
  static Widget prepare(PettyCash pettyCash) {
    return BlocProvider(
      ...
      child: PettyCashApproveAccountingButton._(pettyCash: pettyCash),
    );
  }
  ...
  Widget build(BuildContext context) {
    const action = DataAction.approveAccounting;
    return LightButton(
      permission: PermissionFinance.pettyCashApproveAccounting,
      action: action,
      onPressed: () async {
          ...
          child: BlocBuilder<PettyCashBloc, PettyCashState>(
            ...
            builder: (context, state) {
              ...
              return CardConfirmation(
                ...
                label: pettyCash.id,
                onConfirm: () {
                  bloc.add(PettyCashEvent.approveAccounting(pettyCash));
                },
              );
            },
          ),
