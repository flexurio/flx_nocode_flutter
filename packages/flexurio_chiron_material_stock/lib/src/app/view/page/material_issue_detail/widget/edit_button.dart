...
class MaterialIssueDetailEditButton extends StatelessWidget {
  const MaterialIssueDetailEditButton({
  ...
  Widget build(BuildContext context) {
    return IconButtonSmall(
      permission: PermissionMaterialStock.materialIssueDetailEdit(
