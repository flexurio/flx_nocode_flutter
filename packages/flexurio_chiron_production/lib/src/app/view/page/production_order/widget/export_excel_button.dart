...
class ProductionOrderBatchExportExcelButton extends StatefulWidget {
  const ProductionOrderBatchExportExcelButton({super.key});
  ...
  static Widget prepare({
    ...
    return MultiBlocProvider(
      ...
      child: const ProductionOrderBatchExportExcelButton(),
    );
  }

  @override
  State<ProductionOrderBatchExportExcelButton> createState() =>
      _ProductionOrderBatchExportExcelButtonState();
}

class _ProductionOrderBatchExportExcelButtonState
    extends State<ProductionOrderBatchExportExcelButton> {
  DateTime? _startDate;
  DateTime? _endDate;
  Product? _product;
                  ...
                  loaded: (productionOrder) {
                    final bytes = simpleExcel<ProductionOrder>(
                      ...
                      columns: [
                        TColumn(
                          title: 'period'.tr(),
                          builder: (data, index) => DateFormat('yyyyMM').format(
                            data.createdAt,
                          ),
                        ),
                        TColumn(
                        ...
                        TColumn(
                          title: 'scale'.tr(),
                          numeric: true,
                          builder: (data, index) => data.scale.label,
                        ),
                      ],
                    );
