...
CashFlowCode _$CashFlowCodeFromJson(Map<String, dynamic> json) {
  return _CashFlowCode.fromJson(json);
}

/// @nodoc
mixin _$CashFlowCode {
  ...
  /// Serializes this CashFlowCode to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CashFlowCode
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CashFlowCodeCopyWith<CashFlowCode> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CashFlowCodeCopyWith<$Res> {
  factory $CashFlowCodeCopyWith(
          CashFlowCode value, $Res Function(CashFlowCode) then) =
      _$CashFlowCodeCopyWithImpl<$Res, CashFlowCode>;
  @useResult
  $Res call(
      {String date,
...
/// @nodoc
class _$CashFlowCodeCopyWithImpl<$Res, $Val extends CashFlowCode>
    implements $CashFlowCodeCopyWith<$Res> {
  _$CashFlowCodeCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CashFlowCodeImplCopyWith<$Res>
    implements $CashFlowCodeCopyWith<$Res> {
  factory _$$CashFlowCodeImplCopyWith(
          _$CashFlowCodeImpl value, $Res Function(_$CashFlowCodeImpl) then) =
      __$$CashFlowCodeImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String date,
...
/// @nodoc
class __$$CashFlowCodeImplCopyWithImpl<$Res>
    extends _$CashFlowCodeCopyWithImpl<$Res, _$CashFlowCodeImpl>
    implements _$$CashFlowCodeImplCopyWith<$Res> {
  __$$CashFlowCodeImplCopyWithImpl(
      _$CashFlowCodeImpl _value, $Res Function(_$CashFlowCodeImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CashFlowCodeImpl(
      date: null == date
          ? _value.date
          : date // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$CashFlowCodeImpl extends _CashFlowCode {
  const _$CashFlowCodeImpl(
      {required this.date,
  ...
  factory _$CashFlowCodeImpl.fromJson(Map<String, dynamic> json) =>
      _$$CashFlowCodeImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CashFlowCode(date: $date, noTransaction: $noTransaction, invoice: $invoice, recForm: $recForm, description: $description, amount: $amount, code: $code, subCode: $subCode, mutationDate: $mutationDate, transferFee: $transferFee, totalTransfer: $totalTransfer, bank: $bank, status: $status)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CashFlowCodeImplCopyWith<_$CashFlowCodeImpl> get copyWith =>
      __$$CashFlowCodeImplCopyWithImpl<_$CashFlowCodeImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CashFlowCodeImplToJson(
      this,
    );
  }
}

abstract class _CashFlowCode extends CashFlowCode {
  const factory _CashFlowCode(
      ...
      required final String status}) = _$CashFlowCodeImpl;
  const _CashFlowCode._() : super._();

  factory _CashFlowCode.fromJson(Map<String, dynamic> json) =
      _$CashFlowCodeImpl.fromJson;
