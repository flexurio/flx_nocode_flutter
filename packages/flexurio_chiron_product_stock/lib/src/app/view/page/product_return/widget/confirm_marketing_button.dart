...
class ProductReturnConfirmMarketingButton extends StatelessWidget {
  const ProductReturnConfirmMarketingButton({
  ...
  static Widget prepare({
    ...
    return BlocProvider(
      ...
      child: ProductReturnConfirmMarketingButton(
  ...
  Widget build(BuildContext context) {
    const action = DataAction.confirmMarketing;
    return LightButton(
          ...
          child: BlocBuilder<ProductReturnBloc, ProductReturnState>(
            ...
            builder: (context, state) {
              ...
              return CardConfirmation(
                ...
                onConfirm: () {
                  bloc.add(
                    ProductReturnEvent.confirmMarketing(
                      productReturn: productReturn,
                    ),
                  );
                },
