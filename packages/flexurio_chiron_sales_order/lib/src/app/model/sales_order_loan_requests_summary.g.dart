...
_$SalesOrderLoanRequestsSummaryImpl
    _$$SalesOrderLoanRequestsSummaryImplFromJson(Map<String, dynamic> json) =>
        _$SalesOrderLoanRequestsSummaryImpl(
          salesOrderId: json['sales_order_id'] as String,
          salesOrderDate:
              isoDateToDateTime(json['sales_order_date'] as String?),
          description: json['description'] as String,
          productType: json['product_type'] as String,
          purchaseOrderDistributor:
              json['purchase_order_distributor'] as String,
          ...
          productDiscountPercent:
              (json['product_discount_percent'] as num).toInt(),
...
Map<String, dynamic> _$$SalesOrderLoanRequestsSummaryImplToJson(
        _$SalesOrderLoanRequestsSummaryImpl instance) =>
    <String, dynamic>{
