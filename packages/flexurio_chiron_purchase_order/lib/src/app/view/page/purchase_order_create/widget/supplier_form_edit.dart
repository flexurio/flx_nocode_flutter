...
class PurchaseOrderSupplierFormEditPage extends StatelessWidget {
  const PurchaseOrderSupplierFormEditPage._(this.purchaseOrder);
  ...
  static Route<bool?> route({
    ...
    return PageTransition(
      ...
      child: MultiBlocProvider(
        ...
        child: PurchaseOrderSupplierFormEditPage._(purchaseOrder),
      ),
    );
  }
