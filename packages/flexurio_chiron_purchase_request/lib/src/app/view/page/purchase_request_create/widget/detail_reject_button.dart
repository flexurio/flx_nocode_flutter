...
class MaterialRequestDetailRejectButton extends StatelessWidget {
  const MaterialRequestDetailRejectButton._({
  ...
  static Widget prepare({
    ...
    return BlocProvider(
      create: (context) => bloc,
      child: MaterialRequestDetailRejectButton._(
        bloc: bloc,
  ...
  Widget build(BuildContext context) {
    ...
    return Button.small(
      permission: Permission.purchaseRequestDetailReject,
      action: action,
      color: Colors.red,
      onPressed: () async {
          ...
          child: BlocBuilder<MaterialRequestDetailBloc,
            ...
            builder: (context, state) {
              ...
              return CardConfirmationWithExplanation(
                ...
                onConfirm: (reason) {
                  bloc.add(
                    MaterialRequestDetailEvent.reject(
