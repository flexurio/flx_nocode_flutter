...
part 'sales_order_loan_requests_summary.freezed.dart';
part 'sales_order_loan_requests_summary.g.dart';

@freezed
class SalesOrderLoanRequestsSummary with _$SalesOrderLoanRequestsSummary {
  const factory SalesOrderLoanRequestsSummary({
  ...
  }) = _SalesOrderLoanRequestsSummary;
  const SalesOrderLoanRequestsSummary._();

  factory SalesOrderLoanRequestsSummary.empty() => SalesOrderLoanRequestsSummary(
    productType: '', 
  ...
  factory SalesOrderLoanRequestsSummary.fromJson(Map<String, dynamic> json) => _$SalesOrderLoanRequestsSummaryFromJson(json);
}
