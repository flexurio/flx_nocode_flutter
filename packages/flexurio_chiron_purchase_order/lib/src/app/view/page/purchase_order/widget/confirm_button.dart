...
class PurchaseOrderConfirmButton extends StatelessWidget {
  const PurchaseOrderConfirmButton._({
  ...
  static Widget prepare({
    ...
    return BlocProvider(
      ...
      child: PurchaseOrderConfirmButton._(purchaseOrder: purchaseOrder),
    );
  }
          ...
          child: BlocBuilder<PurchaseOrderBloc, PurchaseOrderState>(
            ...
            builder: (context, state) {
              ...
              return CardConfirmation(
                ...
                onConfirm: () {
                  bloc.add(PurchaseOrderEvent.confirm(purchaseOrder));
                },
              );
            },
          ),
