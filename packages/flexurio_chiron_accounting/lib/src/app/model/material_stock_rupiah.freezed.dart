...
MaterialStockRupiah _$MaterialStockRupiahFromJson(Map<String, dynamic> json) {
  return _MaterialStockRupiah.fromJson(json);
}

/// @nodoc
mixin _$MaterialStockRupiah {
  @JsonKey(name: 'year')
  ...
  /// Serializes this MaterialStockRupiah to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of MaterialStockRupiah
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $MaterialStockRupiahCopyWith<MaterialStockRupiah> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $MaterialStockRupiahCopyWith<$Res> {
  factory $MaterialStockRupiahCopyWith(
          MaterialStockRupiah value, $Res Function(MaterialStockRupiah) then) =
      _$MaterialStockRupiahCopyWithImpl<$Res, MaterialStockRupiah>;
  @useResult
  $Res call(
      ...
      @JsonKey(name: 'dk') String dk,
      @JsonKey(name: 'process_date', fromJson: isoDateToDateTime)
      DateTime processDate});
}

/// @nodoc
class _$MaterialStockRupiahCopyWithImpl<$Res, $Val extends MaterialStockRupiah>
    implements $MaterialStockRupiahCopyWith<$Res> {
  _$MaterialStockRupiahCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$MaterialStockRupiahImplCopyWith<$Res>
    implements $MaterialStockRupiahCopyWith<$Res> {
  factory _$$MaterialStockRupiahImplCopyWith(_$MaterialStockRupiahImpl value,
          $Res Function(_$MaterialStockRupiahImpl) then) =
      __$$MaterialStockRupiahImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'year') String year,
...
/// @nodoc
class __$$MaterialStockRupiahImplCopyWithImpl<$Res>
    extends _$MaterialStockRupiahCopyWithImpl<$Res, _$MaterialStockRupiahImpl>
    implements _$$MaterialStockRupiahImplCopyWith<$Res> {
  __$$MaterialStockRupiahImplCopyWithImpl(_$MaterialStockRupiahImpl _value,
      $Res Function(_$MaterialStockRupiahImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$MaterialStockRupiahImpl(
      year: null == year
          ? _value.year
          : year // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$MaterialStockRupiahImpl extends _MaterialStockRupiah {
  const _$MaterialStockRupiahImpl(
      ...
      @JsonKey(name: 'dk') required this.dk,
      @JsonKey(name: 'process_date', fromJson: isoDateToDateTime)
      required this.processDate})
      : super._();

  factory _$MaterialStockRupiahImpl.fromJson(Map<String, dynamic> json) =>
      _$$MaterialStockRupiahImplFromJson(json);
  ...
  @override
  String toString() {
    return 'MaterialStockRupiah(year: $year, month: $month, transactionId: $transactionId, materialId: $materialId, na: $na, date: $date, materialName: $materialName, quantity: $quantity, unit: $unit, price: $price, value: $value, materialGroupId: $materialGroupId, batchProduct: $batchProduct, dk: $dk, processDate: $processDate)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$MaterialStockRupiahImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$MaterialStockRupiahImplCopyWith<_$MaterialStockRupiahImpl> get copyWith =>
      __$$MaterialStockRupiahImplCopyWithImpl<_$MaterialStockRupiahImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$MaterialStockRupiahImplToJson(
      this,
    );
  }
}

abstract class _MaterialStockRupiah extends MaterialStockRupiah {
  const factory _MaterialStockRupiah(
      ...
      @JsonKey(name: 'dk') required final String dk,
      @JsonKey(name: 'process_date', fromJson: isoDateToDateTime)
      required final DateTime processDate}) = _$MaterialStockRupiahImpl;
  const _MaterialStockRupiah._() : super._();

  factory _MaterialStockRupiah.fromJson(Map<String, dynamic> json) =
      _$MaterialStockRupiahImpl.fromJson;
