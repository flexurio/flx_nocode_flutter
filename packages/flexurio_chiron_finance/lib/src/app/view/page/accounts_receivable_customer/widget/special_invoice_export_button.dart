...
class _SpecialInvoiceExportPdfButtonState
  ...
  final _transcationDateGteController = TextEditingController();
                ...
                state.maybeWhen(
                  ...
                  loaded: (accountsReceivableDetail) async {
                    ...
                    await Printing.sharePdf(
                      ...
                      filename:
                          'LPU_LAPORAN_KARTU_PIUTANG_per_CUSTOMER_by_TGL_FAKTUR_KHUSUS.pdf',
                    );
                  },
                );
              },
          ...
          child: Column(
            ...
            children: [
              ...
              FieldDatePicker(
                ...
                controller: _transcationDateGteController,
                onChanged: (value) {
