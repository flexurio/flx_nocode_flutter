...
Future<Page> pdfMaterialStatusRupiah({
  required List<MaterialStatusRupiah> data,
  DateTime? startDate,
  DateTime? endDate,
}) async {
  ...
  return pdfTemplate(
    printedBy: printedBy,
    headerTitle: 'REKAP RELEASE / REJECT MATERIAL KEMASAN',
    headerChild: Padding(
            ...
            columns: [
              ...
              PColumnHeader(
                ...
                children: [
                  ...
                  PColumnHeader(title: 'JUMLAH (Rp.)', numeric: true),
                ],
              ),
              PColumnHeader(
                flex: 4,
    ...
    build: (context) => [
      ...List.generate(data.length, (index) {
        return Padding(
          ...
          child: tableBody<MaterialStatusRupiah>(
            data: [data[index]],
            columns: [
              PColumnBody(
                flex: 2,
              ...
              PColumnBody(
                flex: 2,
                contentBuilder: (data, index) => data.vatTotal.format(),
              ),
              PColumnBody(
                flex: 2,
              ...
              PColumnBody(
                flex: 2,
                contentBuilder: (data, index) => data.quantityRelease.format(),
              ),
              PColumnBody(
                flex: 2,
                contentBuilder: (data, index) => data.valueRelease.format(),
              ),
              PColumnBody(
                flex: 2,
                contentBuilder: (data, index) => data.quantityReject.format(),
              ),
              PColumnBody(
                flex: 2,
                contentBuilder: (data, index) => data.valueReject.format(),
              ),
            ],
          ),
        );
