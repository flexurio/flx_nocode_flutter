...
class ProductFormulationNonActiveButton extends StatelessWidget {
  const ProductFormulationNonActiveButton._({
    required this.id,
  });
  ...
  static Widget prepare({
    ...
    return MultiBlocProvider(
      ...
      child: ProductFormulationNonActiveButton._(id: id),
    );
  }
  ...
  Future<bool?> _showConfirmDialog(
    ...
    return showDialog<bool?>(
      ...
      context: context,
      builder: (context) {
        const action = DataAction.deactivate;
              ...
              return CardForm(
                ...
                actions: [
                  ...
                  Button(
                    ...
                    onPressed: () {
                      bloc.add(ProductFormulationEvent.nonActive(id));
                    },
                    action: DataAction.deactivate,
                  ),
                ],
