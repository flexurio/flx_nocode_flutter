...
class PurchaseOrderDeleteButton extends StatelessWidget {
  const PurchaseOrderDeleteButton._({
  ...
  static Widget prepare({
    ...
    return BlocProvider(
      ...
      child: PurchaseOrderDeleteButton._(purchaseOrder: purchaseOrder),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return IconButtonSmall(
      permission: PermissionPurchaseOrder.purchaseOrderDelete,
      action: action,
      onPressed: () async {
          ...
          child: BlocBuilder<PurchaseOrderBloc, PurchaseOrderState>(
            ...
            builder: (context, state) {
              ...
              return CardConfirmation(
                ...
                onConfirm: () {
                  bloc.add(PurchaseOrderEvent.delete(purchaseOrder));
                },
              );
            },
          ),
