...
part of 'sales_order_donation_summary.dart';
...
SalesOrderDonationSummary _$SalesOrderDonationSummaryFromJson(
    Map<String, dynamic> json) {
  return _SalesOrderDonationSummary.fromJson(json);
}

/// @nodoc
mixin _$SalesOrderDonationSummary {
  ...
  /// Serializes this SalesOrderDonationSummary to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of SalesOrderDonationSummary
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $SalesOrderDonationSummaryCopyWith<SalesOrderDonationSummary> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SalesOrderDonationSummaryCopyWith<$Res> {
  factory $SalesOrderDonationSummaryCopyWith(SalesOrderDonationSummary value,
          $Res Function(SalesOrderDonationSummary) then) =
      _$SalesOrderDonationSummaryCopyWithImpl<$Res, SalesOrderDonationSummary>;
  @useResult
  $Res call(
...
/// @nodoc
class _$SalesOrderDonationSummaryCopyWithImpl<$Res,
        $Val extends SalesOrderDonationSummary>
    implements $SalesOrderDonationSummaryCopyWith<$Res> {
  _$SalesOrderDonationSummaryCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$SalesOrderDonationSummaryImplCopyWith<$Res>
    implements $SalesOrderDonationSummaryCopyWith<$Res> {
  factory _$$SalesOrderDonationSummaryImplCopyWith(
          _$SalesOrderDonationSummaryImpl value,
          $Res Function(_$SalesOrderDonationSummaryImpl) then) =
      __$$SalesOrderDonationSummaryImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'sales_order_id') String salesOrderId,
...
/// @nodoc
class __$$SalesOrderDonationSummaryImplCopyWithImpl<$Res>
    extends _$SalesOrderDonationSummaryCopyWithImpl<$Res,
        _$SalesOrderDonationSummaryImpl>
    implements _$$SalesOrderDonationSummaryImplCopyWith<$Res> {
  __$$SalesOrderDonationSummaryImplCopyWithImpl(
      _$SalesOrderDonationSummaryImpl _value,
      $Res Function(_$SalesOrderDonationSummaryImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$SalesOrderDonationSummaryImpl(
      salesOrderId: null == salesOrderId
          ? _value.salesOrderId
          : salesOrderId // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$SalesOrderDonationSummaryImpl extends _SalesOrderDonationSummary {
  const _$SalesOrderDonationSummaryImpl(
  ...
  factory _$SalesOrderDonationSummaryImpl.fromJson(Map<String, dynamic> json) =>
      _$$SalesOrderDonationSummaryImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$SalesOrderDonationSummaryImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SalesOrderDonationSummaryImplCopyWith<_$SalesOrderDonationSummaryImpl>
      get copyWith => __$$SalesOrderDonationSummaryImplCopyWithImpl<
          _$SalesOrderDonationSummaryImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$SalesOrderDonationSummaryImplToJson(
      this,
    );
  }
}

abstract class _SalesOrderDonationSummary extends SalesOrderDonationSummary {
  const factory _SalesOrderDonationSummary(
      ...
      required final DateTime
          deliveryOrderDate}) = _$SalesOrderDonationSummaryImpl;
  const _SalesOrderDonationSummary._() : super._();

  factory _SalesOrderDonationSummary.fromJson(Map<String, dynamic> json) =
      _$SalesOrderDonationSummaryImpl.fromJson;
