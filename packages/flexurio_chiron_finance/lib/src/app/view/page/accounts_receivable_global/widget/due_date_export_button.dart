...
import 'package:flexurio_chiron_finance/src/app/view/page/accounts_receivable_detail/util/pdf_due_date.dart';
...
class DueDateExportPdfButton extends StatefulWidget {
  const DueDateExportPdfButton({super.key});
  ...
  static Widget prepare() {
    return MultiBlocProvider(
      ...
      child: const DueDateExportPdfButton(),
    );
  }

  @override
  State<DueDateExportPdfButton> createState() => _DueDateExportPdfButtonState();
}

class _DueDateExportPdfButtonState extends State<DueDateExportPdfButton> {
                ...
                state.maybeWhen(
                  ...
                  loaded: (accountsReceivableDetail) async {
                    ...
                    await Printing.sharePdf(
                      ...
                      filename:
                          'LPU - LAPORAN SALDO PIUTANG GLOBAL by TGL JATUH TEMPO.pdf',
                    );
                  },
                );
              },
