...
class PettyCashRejectAccountingButton extends StatelessWidget {
  const PettyCashRejectAccountingButton._({
  ...
  static Widget prepare(PettyCash pettyCash) {
    return BlocProvider(
      ...
      child: PettyCashRejectAccountingButton._(pettyCash: pettyCash),
    );
  }
  ...
  Widget build(BuildContext context) {
    const action = DataAction.rejectAccounting;
    return LightButton(
            ...
            builder: (context, state) {
              ...
              return CardConfirmationWithExplanation(
                ...
                onConfirm: (explanation) {
                  bloc.add(
                    PettyCashEvent.rejectAccounting(
                      pettyCash,
                      explanation,
                    ),
                  );
