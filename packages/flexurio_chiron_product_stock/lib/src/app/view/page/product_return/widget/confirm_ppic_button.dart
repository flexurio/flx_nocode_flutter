...
class ProductReturnConfirmPpicButton extends StatelessWidget {
  const ProductReturnConfirmPpicButton({
  ...
  static Widget prepare({
    ...
    return BlocProvider(
      ...
      child: ProductReturnConfirmPpicButton(
  ...
  Widget build(BuildContext context) {
    const action = DataAction.confirmPpic;
    return LightButton(
          ...
          child: BlocBuilder<ProductReturnBloc, ProductReturnState>(
            ...
            builder: (context, state) {
              ...
              return CardConfirmation(
                ...
                onConfirm: () {
                  bloc.add(
                    ProductReturnEvent.confirmPpic(
                      productReturn: productReturn,
                    ),
                  );
                },
