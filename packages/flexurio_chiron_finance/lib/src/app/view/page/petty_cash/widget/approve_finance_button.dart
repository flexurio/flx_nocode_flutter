...
class PettyCashApproveFinanceButton extends StatelessWidget {
  const PettyCashApproveFinanceButton._({
  ...
  static Widget prepare(PettyCash pettyCash) {
    return BlocProvider(
      ...
      child: PettyCashApproveFinanceButton._(pettyCash: pettyCash),
    );
  }
  ...
  Widget build(BuildContext context) {
    const action = DataAction.approveFinance;
    return LightButton(
          ...
          child: BlocBuilder<PettyCashBloc, PettyCashState>(
            ...
            builder: (context, state) {
              ...
              return CardConfirmation(
                ...
                label: pettyCash.id,
                onConfirm: () {
                  bloc.add(PettyCashEvent.approveFinance(pettyCash));
                },
              );
            },
          ),
