...
part 'material_stock_in_rupiah.freezed.dart';
part 'material_stock_in_rupiah.g.dart';

@freezed
class MaterialStockInRupiah with _$MaterialStockInRupiah {
  const factory MaterialStockInRupiah({
  ...
  }) = _MaterialStockInRupiah;
  const MaterialStockInRupiah._();

  factory MaterialStockInRupiah.empty() => MaterialStockInRupiah(
    year: '', 
    month: '', 
    transactionId: '', 
    materialId: '', 
  ...
  factory MaterialStockInRupiah.fromJson(Map<String, dynamic> json) => _$MaterialStockInRupiahFromJson(json);
}
