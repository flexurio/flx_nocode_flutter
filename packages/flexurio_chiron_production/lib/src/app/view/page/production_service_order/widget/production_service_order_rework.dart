...
class ProductionServiceOrderReworkButton extends StatelessWidget {
  const ProductionServiceOrderReworkButton._({
  ...
  static Widget prepare({
    ...
    return BlocProvider(
      ...
      child: ProductionServiceOrderReworkButton._(
              ...
              return CardConfirmation(
                ...
                onConfirm: () {
                  productionServiceOrderBloc.add(
                    ProductionServiceOrderEvent.rework(productionServiceOrder),
                  );
                },
              );
            },
