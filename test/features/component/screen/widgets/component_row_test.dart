...
void main() {
  testWidgets(
      'ComponentRow should respect x_align: right even with single child',
      (tester) async {
    ...
    expect(rowFinder, findsOneWidget,
        reason:
            'Row should be rendered even for single child to preserve alignment');
  ...
  testWidgets('ComponentRow should respect x_align: center with single child',
      (tester) async {
    final component = ComponentRow(
      id: 'center_row',
      xAlign: 'center',
  ...
  testWidgets('ComponentRow should not add gaps for hidden children',
      (tester) async {
    final component = ComponentRow(
      id: 'row',
      horizontalGap: 10,
