...
class PettyCashApproveManagerButton extends StatelessWidget {
  const PettyCashApproveManagerButton._({
  ...
  static Widget prepare(PettyCash pettyCash) {
    return BlocProvider(
      ...
      child: PettyCashApproveManagerButton._(pettyCash: pettyCash),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return LightButton(
      permission: PermissionFinance.pettyCashApproveManager,
      action: action,
      onPressed: () async {
            ...
            builder: (context, state) {
              ...
              return CardConfirmationWithExplanation(
                ...
                onConfirm: (explanation) {
                  bloc.add(
                    PettyCashEvent.approveManager(pettyCash, explanation),
                  );
                },
              );
            },
