...
class VehicleRentRejectCsButton extends StatelessWidget {
  const VehicleRentRejectCsButton._({
  ...
  static Widget prepare({
    ...
    return BlocProvider(
      ...
      child: VehicleRentRejectCsButton._(
  ...
  Widget build(BuildContext context) {
    return IconButtonSmall(
      permission: Permission.vehicleRentRejectCs,
      action: DataAction.rejectCs,
      onPressed: () async {
  ...
  Future<bool?> _showConfirmationDialog(
    ...
    return showDialog<bool?>(
      ...
      context: context,
      builder: (context) {
        const action = DataAction.rejectCs;
