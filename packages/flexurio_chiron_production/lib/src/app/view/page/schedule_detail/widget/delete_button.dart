...
class ScheduleDetailDeleteButton extends StatelessWidget {
  const ScheduleDetailDeleteButton({
  ...
  static Widget prepare({
    ...
    return BlocProvider(
      ...
      child: ScheduleDetailDeleteButton(
  ...
  Widget build(BuildContext context) {
    ...
    return IconButtonSmall(
      permission:
          PermissionProduction.scheduleDetailDelete(isExternal: isExternal),
      onPressed: () async {
          ...
          child: BlocBuilder<ScheduleDetailBloc, ScheduleDetailBlocState>(
            ...
            builder: (context, state) {
              ...
              return CardConfirmation(
                ...
                onConfirm: () {
                  bloc.add(
                    ScheduleDetailBlocEvent.delete(id: scheduleDetail.id),
                  );
                },
              );
            },
