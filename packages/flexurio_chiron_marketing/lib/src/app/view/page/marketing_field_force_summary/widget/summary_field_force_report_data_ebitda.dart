...
class SummaryFieldForceReportDataEbitda extends StatefulWidget {
  const SummaryFieldForceReportDataEbitda({
  ...
  final List<SummaryFieldForceEbitdaGrade1> summaryFieldForces;
  ...
  @override
  State<SummaryFieldForceReportDataEbitda> createState() =>
      _SummaryFieldForceReportDataEbitdaState();
}

class _SummaryFieldForceReportDataEbitdaState
    extends State<SummaryFieldForceReportDataEbitda> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget buildSummaryFFsValue({
      required SummaryFieldForceEbitda summaryFieldForce,
      required int month,
    ...
    Widget buildRowValueSummaryFFsGrade3(
      ...
      final id3 = '$id.$index2.$index3';
      final visible = summaryFieldForceGradeVisibility.contains(id3);
      // print(widget.summaryFieldForces[id].children[index2].children);
      return Column(
        children: [
    ...
    Widget buildRowValueSummaryFFsGrade1(int row, int column) {
      ...
      return Column(
        children: [
          buildSummaryFFsValue(
            summaryFieldForce: widget.summaryFieldForces[row],
            borderTop: row != 0,
            borderLeft: column != 0,
            month: column,
            // month: column + 1,
