...
class PurchaseOrderUndoConfirmAccountingButton extends StatelessWidget {
  const PurchaseOrderUndoConfirmAccountingButton._({
  ...
  static Widget prepare({
    ...
    return BlocProvider(
      ...
      child: PurchaseOrderUndoConfirmAccountingButton._(
          ...
          child: BlocBuilder<PurchaseOrderBloc, PurchaseOrderState>(
            ...
            builder: (context, state) {
              ...
              return CardConfirmation(
                ...
                onConfirm: () {
                  bloc.add(
                    PurchaseOrderEvent.accountingUndoConfirm(purchaseOrder),
                  );
                },
              );
            },
