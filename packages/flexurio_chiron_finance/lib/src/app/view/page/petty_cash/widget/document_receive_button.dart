...
class PettyCashDocumentReceiveButton extends StatelessWidget {
  const PettyCashDocumentReceiveButton._({
  ...
  static Widget prepare(PettyCash pettyCash) {
    return BlocProvider(
      ...
      child: PettyCashDocumentReceiveButton._(pettyCash: pettyCash),
    );
  }
  ...
  Widget build(BuildContext context) {
    const action = DataAction.documentReceive;
    return LightButton(
      permission: PermissionFinance.pettyCashDocumentReceive,
      action: action,
      onPressed: () async {
          ...
          child: BlocBuilder<PettyCashBloc, PettyCashState>(
            ...
            builder: (context, state) {
              ...
              return CardConfirmation(
                ...
                onConfirm: () {
                  bloc.add(
                    PettyCashEvent.documentReceive(pettyCash),
                  );
                },
              );
            },
