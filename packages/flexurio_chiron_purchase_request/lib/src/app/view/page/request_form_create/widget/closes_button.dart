...
class RequestFormDetailClosesButton extends StatelessWidget {
  const RequestFormDetailClosesButton({
  ...
  static Widget prepare({
    ...
    return RequestFormDetailClosesButton(
      bloc: bloc,
      ...
      builder: (context) {
        return BlocListener<RequestFormDetailBloc, RequestFormDetailState>(
          ...
          listener: (context, state) {
            state.maybeWhen(
              success: () {
                Toast(context).dataChanged(DataAction.close, entity);
          ...
          child: BlocBuilder<RequestFormDetailBloc, RequestFormDetailState>(
            ...
            builder: (context, state) {
              ...
              return CardConfirmation(
                ...
                onConfirm: () {
                  bloc.add(
                    RequestFormDetailEvent.closeList(
                      materialRequestDetail: requestFormDetails,
                    ),
                  );
                },
              );
