...
import 'package:flexurio_chiron_finance/src/app/view/page/accounts_receivable_global/util/pdf_invoice.dart';
                ...
                state.maybeWhen(
                  ...
                  loaded: (accountsReceivableDetail) async {
                    ...
                    await Printing.sharePdf(
                      ...
                      filename:
                          'LPU - LAPORAN SALDO PIUTANG GLOBAL by TGL FAKTUR KHUSUS.pdf',
                    );
                  },
                );
              },
